...
function (_React$Component) {
  ...
  function MaterialTable(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "getRenderData", function (data, props) {
      ...
      var groups = _this.state && _this.state.columns.filter(function (col) {
      ...
      if (groups && groups.length > 0) {
        renderData = _this.groupBy(renderData, groups);
        ...
        var sortGroups = function sortGroups(list, columnDef) {
          if (columnDef.customSort) {
            ...
            return list.sort(columnDef.tableData.groupSort === 'desc' ? function (a, b) {
              return _this.sort(b.value, a.value, columnDef.type);
            } : function (a, b) {
              return _this.sort(a.value, b.value, columnDef.type);
            });
          }
        };
          ...
          list.forEach(function (element) {
            if (element.groups.length > 0) {
              ...
              if (_this.state && _this.state.orderBy >= 0 && _this.state.orderDirection) {
                element.data = _this.sortList(element.data);
              }
            }
          });
        };
      ...
      } else if (_this.state && _this.state.orderBy >= 0 && _this.state.orderDirection) {
        renderData = _this.sortList(renderData);
      }

      return renderData || data;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "sortList", function (list) {
      ...
      if (columnDef.customSort) {
        ...
        result = list.sort(_this.state.orderDirection === 'desc' ? function (a, b) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "reOrderGroups", function (result) {
      var start = 0;

      var groups = _this.state.columns.filter(function (col) {
        return col.tableData.groupOrder > -1;
      }).sort(function (col1, col2) {
        return col1.tableData.groupOrder - col2.tableData.groupOrder;
      });
      ...
      if (result.destination.droppableId === "groups" && result.source.droppableId === "groups") {
        ...
        var newGroup = _this.state.columns.find(function (c) {
        ...
        var removeGroup = _this.state.columns.find(function (c) {
          return c.tableData.id == result.draggableId;
        });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "findDataByPath", function (renderData, path) {
      var data = {
        groups: renderData
      };
  ...
  (0, _createClass2.default)(MaterialTable, [{
    ...
    key: "groupBy",
    value: function groupBy(data, groups) {
      var _this3 = this;

      var subData = data.reduce(function (result, current) {
        var object = result;
        object = groups.reduce(function (o, colDef) {
          var value = current[colDef.field] || _this3.byString(current, colDef.field);
    ...
    value: function render() {
      ...
      return React.createElement(_reactBeautifulDnd.DragDropContext, {
        ...
        onSortChanged: function onSortChanged(groupedColumn) {
          var columns = _this5.state.columns;
          var column = columns.find(function (c) {
            return c.tableData.id === groupedColumn.tableData.id;
          });
        ...
        return React.createElement("div", {
          ...
          dataCount: _this5.state.data.length,
          ...
          onAllSelected: function onAllSelected(checked) {
            var renderData = _this5.state.renderData;
            var selectedCount = 0;

            if (_this5.state.columns.filter(function (g) {
              return g.tableData.groupOrder > -1;
            }).length > 0) {
              ...
              renderData = renderData.map(function (row) {
          ...
          getFieldValue: _this5.getFieldValue,
          ...
          onRowSelected: function onRowSelected(event, path) {
            ...
            var node = _this5.findDataByPath(renderData, path);
          ...
          onToggleDetailPanel: function onToggleDetailPanel(path, render) {
            ...
            var targetRow = _this5.findDataByPath(renderData, path);
