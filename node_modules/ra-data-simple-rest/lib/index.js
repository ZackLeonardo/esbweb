...
exports.default = function(apiUrl) {
  var httpClient =
    arguments.length > 1 && arguments[1] !== undefined
      ? arguments[1]
      : _reactAdmin.fetchUtils.fetchJson;
   ...
   */
  var convertDataRequestToHTTP = function convertDataRequestToHTTP(
    type,
    resource,
    params
  ) {
    ...
    switch (type) {
      case _reactAdmin.GET_LIST: {
        ...
        var query = {
          ...
          flag: JSON.stringify(params.flag)
        };
        url =
          apiUrl + "/" + resource + "?" + (0, _queryString.stringify)(query);
        break;
      }
      ...
      case _reactAdmin.GET_MANY: {
        ...
        url =
          apiUrl + "/" + resource + "?" + (0, _queryString.stringify)(_query);
        break;
      }
      case "MY_GET_MANY": {
        var _query = {
        ...
        var _query2 = {
          ...
          filter: JSON.stringify(
            (0, _extends4.default)(
              {},
              params.filter,
              (0, _defineProperty3.default)({}, params.target, params.id)
            )
          )
        };
        url =
          apiUrl + "/" + resource + "?" + (0, _queryString.stringify)(_query2);
        break;
      }
   ...
   */
  var convertHTTPResponse = function convertHTTPResponse(
    response,
    type,
    resource,
    params
    ...
    switch (type) {
      ...
      case _reactAdmin.CREATE:
        return {
          data: (0, _extends4.default)({}, params.data, { id: json.id })
        };
      default:
        return { data: json };
    }
  ...
  return function(type, resource, params) {
    ...
    var _convertDataRequestTo = convertDataRequestToHTTP(
        type,
        resource,
        params
      ),
