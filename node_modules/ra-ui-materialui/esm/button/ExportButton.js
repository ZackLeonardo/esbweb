  ...
  function ExportButton() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref4 =
          ExportButton.__proto__ ||
          Object.getPrototypeOf(ExportButton)).call.apply(
          _ref4,
          [this].concat(args)
        )
      )),
      ...
      (_this.handleClick = function() {
        ...
        dispatch(
          crudGetAll(resource, sort, filter, maxResults, function(_ref5) {
